...
st.set_page_config(page_title='YouTube Project By Praveen',layout="wide")

with st.sidebar:                                     # Navbar
    selected = option_menu(    menu_title='Project',
                               options=['INTRO',"Data Extract And Mongo Load","View Document",'Sql Data Load','Data Anlaysis','Delete Mongo Documents','Delete SQL Records','FEEDBACK'],
...
if selected == 'INTRO':
            ...
            with col2:
                st.markdown(
                    "<h1 style='font-size: 100px;'><span style='color:white;'>Data</span> <span style='color: cyan;'> Engineer </span> <span style='color:white;'></span> <span style='color: white ;'> From </span> <span style='color: cyan;'> India </span></h1>",
                    unsafe_allow_html=True)
            ...
            with col1:
                st.markdown(
                    "<h1 style='font-size: 80px;'><span style='color:cyan;'>About </span><span style='color:white   ;'>Project</span> </h1>",
                    unsafe_allow_html=True)
            ...
            with col1:
                st.markdown(
                    "<h1 style='font-size: 70px;'><span style='color:cyan;'>API</span><span style='color:white;'>  </span><span style='color:whiteIntegration;'>Integration</span> </h1>",
                    unsafe_allow_html=True)
            col1,col2,col3 = st.columns([5,10,2])
            col2.write("")
            col2.write("")
            ...
            with col1:
                st.markdown(
                    "<h1 style='font-size: 90px;'><span style='color:cyan;'> Data </span><span style='color:white;'> Cleaning </span><span style='color:cyan;'> And</span><span style='color:white;'> Preprocessing  </span> </h1>",
                    unsafe_allow_html=True)
            col1,col2,col3 = st.columns([5,10,2])
            col2.write("")
            col2.write("")
            ...
            with col1:
                st.markdown(
                    "<h1 style='font-size: 100px;'><span style='color:cyan;'>Data</span><span style='color:white;'>  </span><span style='color:white;'> Storage</span> </h1>",
                    unsafe_allow_html=True)
            col1,col2,col3 = st.columns([5,10,2])
            col2.write("")
            ...
            with col1:
                st.markdown(
                    "<h1 style='font-size: 90px;'><span style='color:cyan;'> Maintain </span><span style='color:white;'> and  </span><span style='color:cyan;'> Monitor </span> </h1>",
                    unsafe_allow_html=True)
            col1,col2,col3 = st.columns([5,10,2])
            col2.write("")
            col2.write("")
            ...
            with col2:
                ...
                st.markdown(
                    "<h1 style='font-size: 70px;'><span style='color:cyan;'>DATA EXTRACT</span> <span style='color: white;'>AND </span> <span style='color:cyan;'>MONGO LOAD</span> </h1>",
                    unsafe_allow_html=True)
                
            chan_id = st.text_input("")
        ...
        # Stage 2 : Documents Names  Selection process to Migration of mongo Docs into Sql records
            ...
            with col2:
                ...
                st.markdown(
                    "<h1 style='font-size: 70px;'><span style='color:cyan;'>SQL</span> <span style='color: white;'>DATA</span> <span style='color:cyan;'>LOAD</span> </h1>",
                    unsafe_allow_html=True)
            Names = Object.getChannelNames()
            if len(Names)>0:
                Channel_name = st.selectbox("  ", Names)
                cursor.execute("select channel_name from channel")
            ...
            with col2:
                ...
                st.markdown(
                    "<h1 style='font-size: 70px;'><span style='color:cyan;'>DATA </span> <span style='color: white;'>ANALYSIS </span> <span style='color:cyan;'>MONGO </span> </h1>",
                    unsafe_allow_html=True)
                Object.da_query()
            ...
            with col2:
                ...
                st.markdown(
                    "<h1 style='font-size: 70px;'><span style='color:cyan;'>VIEW</span> <span style='color: white;'>AND </span> <span style='color:cyan;'>DOCUMENT  </span> </h1>",
                    unsafe_allow_html=True)
            Names = Object.getChannelNames()
            if len(Names)>0:
                chan_name = st.selectbox('',Names)
            ...
            with col2:
                ...
                st.markdown(
                    "<h1 style='font-size: 70px;'><span style='color:cyan;'>DELETE</span> <span style='color: white;'>MONGO </span> <span style='color:cyan;'>DOCUMENTS</span> </h1>",
                    unsafe_allow_html=True)
            Object.delmongodoc()
            ...
            with col2:
                ...
                st.markdown(
                    "<h1 style='font-size: 70px;'><span style='color:cyan;'>DROP </span> <span style='color: white;'>SQL</span> <span style='color:cyan;'>RECORDS </span> </h1>",
                    unsafe_allow_html=True)
            Object.delsqlrec()
